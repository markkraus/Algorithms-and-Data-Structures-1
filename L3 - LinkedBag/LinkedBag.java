...
public final class LinkedBag<T> implements BagInterface<T>
{
  ...
  public BagInterface<T> union(BagInterface<T> anotherBag) {
    BagInterface<T> bag = new LinkedBag<>();
    Node curr = firstNode;

    while (curr != null) {
      // Add contents of this.LinkedBag
      bag.add(curr.data);
      curr = curr.next;
    }

    LinkedBag<T> otherBag = (LinkedBag<T>) anotherBag;
    curr = otherBag.firstNode;
    while (curr != null) {
      // Add contents of anotherBag
      bag.add(curr.data);
      curr = curr.next;
    }
  ...
  public BagInterface<T> intersection(BagInterface<T> anotherBag) {
    LinkedBag<T> arg = (LinkedBag<T>) anotherBag;
    LinkedBag<T> copy = new LinkedBag<T>();
    Node argFront = arg.firstNode;
    while (argFront != null) {
      copy.add(argFront.data);
      argFront = argFront.next;
    }

    BagInterface<T> newBag = new LinkedBag<T>();
    Node currFront = firstNode;
    while (currFront != null) {
      if (copy.remove(currFront.data))
        newBag.add(currFront.data);
