...
// CS 0445 Spring 2022
// Modification of author's HashedDictionary as specified in Recitation Exercise 11.
// For details see Recitation Exercise 11
...
/**
   ...
   Notes: Uses probe for add, remove, and getValue.
...
public class HashedDictionary<K, V> implements DictionaryInterface<K, V>
{
   ...
   private boolean initialized = false;
	private double MAX_LOAD_FACTOR = 0.5;    // Fraction of hash table that can be filled
